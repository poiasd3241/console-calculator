	...
	class Program
	{
		static void Main(string[] args)
		{
			...
			while (!endApp)
			{
				...
				Console.WriteLine(OperationResult(cleanNum1, cleanNum2, op));
		...
		private static string OperationResult(double number1, double number2, string operation)
		{
			try
			{
				var result = Calculator.DoOperation(number1, number2, operation);
